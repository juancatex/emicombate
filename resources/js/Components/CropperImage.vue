...
<template> 
     <div :class="modelValue?'d-grid':''">
         <button v-if="modelValue" type="button" class="btn btn-outline-info btn-sm" @click="$refs.fileon.click()">Cambiar  imagen</button>
         <button v-else type="button" class="btn btn-outline-success btn-sm" @click="$refs.fileon.click()">Seleccionar  imagen</button>
